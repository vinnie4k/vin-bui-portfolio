...
<body>
  ...
  <main>
    <!-- Source: (orignal work) Vin Bui -->
    <div class="scribbly-logo fadeIn1">
      <img src="https://storage.googleapis.com/portfolio-377906.appspot.com/public/images/scribbly/logo_transparent.png" alt="">
    </div>

    <!-- page heading -->
    <div class="page-heading">
      <div class="first-heading fadeIn2" style="display: flex; justify-content: center;">
        <h1 style="font-size: 40px; font-weight: 300;">Coming soon!</h1>
      </div>
    </div>
  </main>
